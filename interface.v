...
//   bit 7   -> nao usado (0)
//   bit 6   -> ESPECIAL (1=carta especial, 0=carta numerica)
...
module card_decoder (
    ...
    wire        especial = card_id[6];
    wire [1:0]  color    = card_id[5:4];
    ...
    always @(*) begin
        case(color)
            2'd0: hex_color = 8'b1010_1111;  // r (Vermelho)
            2'd1: hex_color = 8'b1001_0001;  // Y (Amarelo)
            2'd2: hex_color = 8'b1100_0010;  // G (Verde)
            2'd3: hex_color = 8'b1000_0011;  // b (Azul)
    ...
    always @(*) begin
        if (!especial) begin
            ...
            // carta especial: val = 0..4
            case(val)
                4'd0: hex_val = 8'b1011_1111; //'-' (Skip)
                4'd1: hex_val = 8'b1110_0011; //'u' (Reverse)
                4'd2: hex_val = 8'b0010_0100; //'2.' (+2)
                4'd3: hex_val = 8'b1100_0110; //'C' (Wild - muda/mantem cor)
                4'd4: hex_val = 8'b0001_1001; //'4.' (+4)
                default: hex_val = 8'b1111_1111;
            endcase
        end
    end
